package cl.camila.configuration;
...
//		PARA ACCEDER A LA BASE DE DATOS DESCOMENTAR
		http.csrf().disable(); //csrf es para seguridad de Spring Security
		http.headers().frameOptions().disable(); //habilitar para acceder a h2-console
		//--------------------------------------
		http
 		.authorizeRequests()
